...
export const requests = {
  LIST_ALL: async () => {
    const characters = [
      {
        ...
        src: "https://i.pinimg.com/originals/aa/d4/8c/aad48cc5521e4b6f73f2f98c5fa3872e.gif"
      },
      {
        name: "Albedo",
        anime: "Overlord",
        ...
        src: "https://i.pinimg.com/originals/47/c1/d0/47c1d033740908d9d21dbe7327413512.gif"
      },
      {
        name: "Irina Shidou",
        ...
        src: "http://pa1.narvii.com/6501/045158e68e3ff8a3ce942ae5a1aeaac73e854928_00.gif"
      },
      {
        name: "Rick Astley",
        anime: "Rick Roll",
    ...
    return new Array(8).fill(0).map((a: any, i: number) => ({
